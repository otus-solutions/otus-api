...
public class StaticVariableRequestDTOTest {
    ...
    private static final String variablesDTOJson = "{recruitmentNumber:2047555, staticVariableRequest:[{identification: 123456, name: tst1,value: Text, sending: 1},{identification: 987456,name: tst1,value: Text, sendingID: 9}]}";
