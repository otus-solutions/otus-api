...
@PrepareForTest({ EmailNotifierServiceBean.class, Equalizer.class, Recipient.class, OtusEmailFactory.class,
		GMailer.class })
public class EmailNotifierServiceBeanTest {
	private static final String USER_NAME = "OtusTestUser";
	private static final String USER_EMAIL = "otusTestUser@otus.com";
	private static final String BASIC_EMAIL_SENDER_NAME = "Otus Local";
	private static final String BASIC_EMAIL_SENDER_VALUE = "ccem.projects@gmail.com";
	private static final String BASIC_EMAIL_SENDER_PASSWORD = "cmFwYWR1cmExMDAyMDAzMDA=";
	@Mock
	...
	public void setUp() throws Exception {
		...
		emailSenderDto = new BasicEmailSender(BASIC_EMAIL_SENDER_NAME, BASIC_EMAIL_SENDER_VALUE,
				BASIC_EMAIL_SENDER_PASSWORD);
