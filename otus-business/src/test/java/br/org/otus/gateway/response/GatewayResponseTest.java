...
public class GatewayResponseTest {
    ...
    @Test
    public void toSurveyJsonMethod_should_return_create_builder_string() {
         assertEquals(GATEWAY_DATA,gatewayResponse.toSurveyJson());
    }

    @Test
    public void toExamJsonMethod_should_return_create_builder_string() {
         assertEquals(GATEWAY_DATA,gatewayResponse.toExamJson());
    }
