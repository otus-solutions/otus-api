...
public class TransportationLotServiceBean implements TransportationLotService {
  ...
  public WorkAliquot getAliquot(WorkAliquotFiltersDTO workAliquotFiltersDTO) throws ValidationException {
    if (transportationLotDao.checkIfThereInTransport(workAliquotFiltersDTO.getCode()) != null)
      throw new ValidationException(new Throwable("There are aliquots in another lot."), workAliquotFiltersDTO.getCode());
