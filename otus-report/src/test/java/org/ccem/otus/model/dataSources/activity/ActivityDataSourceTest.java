...
public class ActivityDataSourceTest {
	...
	private static final String EXPECTED_RESULT_PROJECTION = "{ \"$project\" : { \"_id\" : -1, \"mode\" : 1 } }";
	private static final String EXPECTED_RESULT_PROJECTION_WHIT_STATUS_HISTORY = "{ \"$project\" : { \"_id\" : -1, \"statusHistory\" : 1, \"mode\" : 1 } }";
