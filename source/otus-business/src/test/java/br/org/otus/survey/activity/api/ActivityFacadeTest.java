...
public class ActivityFacadeTest {
  ...
  public void create_method_should_verify_create_with_surveyActivity() {
    when(surveyActivity.getExternalID()).thenReturn("1234");
  ...
  @Test
  public void updateActivity_method_should_call_updateActivity_from_activityTasksService() throws Exception {
  ...
  @Test(expected = HttpResponseException.class)
  public void updateActivity_method_should_throw_HttpResponseException_updateActivity_invalid() throws Exception {
