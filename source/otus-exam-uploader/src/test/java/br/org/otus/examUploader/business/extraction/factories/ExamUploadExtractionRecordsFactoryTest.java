...
public class ExamUploadExtractionRecordsFactoryTest {
  ...
  public void buildResultInformation_method_should_call_createRecordsAnswers_method() throws Exception {
    ...
    this.record = this.createFakeParticipantExamUploadRecord(RECRUITMENT_NUMBER, CODE, RESULT_NAME, VALUE_1, RELEASE_DATE, observations);
  ...
  public void getRecords_method_should_only_return_one_line() {
    List<Observation> observations = new ArrayList<>();
    this.records.add(this.createFakeParticipantExamUploadRecord(RECRUITMENT_NUMBER, CODE, RESULT_NAME, VALUE_1, RELEASE_DATE, observations));
    this.examUploadExtractionRecordsFactory.buildResultInformation();
  ...
  public void getRecords_method_should_return_list_with_expected_values() {
    List<Observation> observations = new ArrayList<>();
    this.records.add(this.createFakeParticipantExamUploadRecord(RECRUITMENT_NUMBER, CODE, RESULT_NAME, VALUE_1,
  ...
  private ParticipantExamUploadResultExtraction createFakeParticipantExamUploadRecord(Long rn, String code, String resultName, String value, String releaseDate, List<Observation> observations) {
