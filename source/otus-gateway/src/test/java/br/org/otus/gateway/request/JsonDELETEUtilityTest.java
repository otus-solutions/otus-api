...
@PrepareForTest({JsonDELETEUtility.class, RequestUtility.class})
public class JsonDELETEUtilityTest {
  ...
  public void setUp() throws Exception {
    ...
    jsonDELETEUtility = new JsonDELETEUtility(requestURL);
  ...
  public void test_should_verify_if_internalConstructorCalls_are_being_invoked() throws IOException {
    verify(httpConn, times(1)).setRequestMethod(RequestTypeOptions.DELETE.getName());
  ...
  public void finish_method_should_return_response() throws IOException {
    ...
    assertEquals(RESPONSE_RESULT, jsonDELETEUtility.finish());
  }
