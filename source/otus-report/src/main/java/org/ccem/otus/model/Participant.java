...
public class Participant {
  ...
  public static String serialize(Participant reportTemplate) {
    return Participant.getGsonBuilder().create().toJson(reportTemplate);
  }

  public static Participant deserialize(String reportTemplateJson) throws ValidationException {
    Participant reportTemplate = Participant.getGsonBuilder().create().fromJson(reportTemplateJson, Participant.class);
    validate(reportTemplate);
    return reportTemplate;
  }

  public static Participant deserializeWithoutValidation(String reportTemplateJson) throws ValidationException {
    Participant reportTemplate = Participant.getGsonBuilder().create().fromJson(reportTemplateJson, Participant.class);
    return reportTemplate;
  }
  ...
  private static void validate(Participant reportTemplate) throws ValidationException {
    String result = "";
